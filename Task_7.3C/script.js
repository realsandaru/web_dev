function validation() {
    ...
    document.getElementById('name_success').innerText = '';
    document.getElementById('email_error').innerText = '';
    document.getElementById('email_success').innerText = '';
    document.getElementById('unitcode_error').innerText = '';
    document.getElementById('unitcode_success').innerText = '';
    document.getElementById('phone_error').innerText = '';
    document.getElementById('phone_success').innerText = '';
